...
void otsu_threshold(Mat inputImg, Mat &dist)
{
    int bins_num = 256;
    ...
    long double thrsh = bin_mids[getmax];
...
int main(int argc, char const *argv[])
{
    ...
    Mat Out;
    Mat inputImg = imread("D:/SBME/ComputerVision/Task_4/otsu/boat.jpg", 0);
    // imshow("IMage", inputImg);
    otsu_threshold(inputImg, Out);
    imshow("IMage", Out);
    waitKey(0);
